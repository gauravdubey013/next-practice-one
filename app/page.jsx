...
const About = () => {
  return (
    <>
      <div className="px-5 max-w-[1560px] mx-auto bg-[#282C33] min-h-screen pt-20 flex items-center justify-between flex-wrap">
        <div className=" w-10/12 sm:w-8/12 mx-auto">
          <h1 className="font-semibold text-[32px] text-white mb-3">
            Gaurav is a <span className="text-[#C778DD]">web designer</span> and{" "}
      ...
      <div className=" px-5 py-10 bg-[#282C33]">
        <Image
          src={require("../public/quote.png")}
          alt="Picture of the author"
          width="3px"
          height="3px"
        />
